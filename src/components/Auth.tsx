...
export default function Auth() {
  ...
  return (
    <div className="animated-gradient-bg min-h-screen px-10 py-16 flex-col">
      <p className="text-2xl">what is insights?</p>
      <p className="text-xl mt-4">
        if you find it difficult to track your expenditure, or if you feel like
        graphs or tables about your bank statement are a better option, welcome
        to insights.
      </p>
      <p className="text-xl mt-4">
        upload your bank statement, and within minutes get graphs, tabulated
        data on your spendings, and you can also talk to it!
      </p>
